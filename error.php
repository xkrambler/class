	...
	function dump($err) {
		...
		// HTML
			...
			<head>
				...
				<style>
					._xerror { background: #FFF; margin: 9px; border: 1px solid #FD4; font-family: Open Sans, Arial, Sans !important; font-size: 15px !important; box-shadow: 0 3px 5px rgba(64,32,0,0.25); tab-size: 2 !important; -moz-tab-size: 2 !important; }
