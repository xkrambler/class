<?php
	...
	/*
		...
		Clase PHP de Acceso a PostgreSQL v0.1, desarrollado por Pablo Rodríguez Rey
	...
	*/
	...
	class dbPgSQL extends dbbase {
		...
		function ready() {
			if (!$this->idcon>0) return false;
			//return ($this->ping($this->idcon) && $this->dbselected?true:false);
		...
		function error() {
			return utf8_decode($this->idcon
				?pg_last_error($this->idcon)
				:$this->pg_connect_last_error
			);
		}
