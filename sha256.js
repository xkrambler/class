...
function SHA256(str) {
	...
	function Σ0(x) { return rrot(2, x) ^ rrot(13, x) ^ rrot(22, x); }
	function Σ1(x) { return rrot(6, x) ^ rrot(11, x) ^ rrot(25, x); }
	function σ0(x) { return rrot(7, x) ^ rrot(18, x) ^ (x >>> 3); }
	function σ1(x) { return rrot(17, x) ^ rrot(19, x) ^ (x >>> 10); }
